...
# 네트워크
- www.google.com 을 브라우저에 입력했을 때, 네트워크에서 어떤 일이 일어나는지 최대한 자세하게 설명하세요.
...
- 저장 프로시저(Stored procedure)에 대해 설명하세요.
- 동적 SQL에 대해 설명하세요.
- DB Locking에 대해 설명하세요.
...
- DB의 Connection pool에 대해 설명하세요.
  - DB와 클라이언트가 connection을 어떻게 구성하는지 설명하세요.
- 트래픽이 높아질 때, DB를 어떻게 관리 해야할까요?
...
- AOP에 대해 설명하세요.
  - @Aspect는 어떻게 동작하나요?
- Spring 에서 Interceptor와 Servlet filter에 대해 설명하세요.
